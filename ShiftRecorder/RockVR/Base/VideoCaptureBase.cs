    ...
    public class VideoCaptureBase : MonoBehaviour
    {
        ...
        public int frameWidth
        {
            get
            {
                ...
                {
                    return ShiftRecorder.Settings.settings.recordingWidth;
                }
                return width;
            }
        }
        ...
        public int frameHeight
        {
            get
            {
                ...
                {
                    return ShiftRecorder.Settings.settings.recordingHeight;
                }
                return height;
            }
        }
        ...
        public int antiAliasing
        {
            get
            {
                return ShiftRecorder.Settings.settings.recordingAntiAliasing;
            }
        }
        /// <summary>
        ...
        public int bitrate
        {
            get
            {
                return ShiftRecorder.Settings.settings.recordingBitrate;
            }
        }
        ...
        public int targetFramerate
        {
            get
            {
                return ShiftRecorder.Settings.settings.recordingTargetFPS;
            }
        }
        /// <summary>
